<div class="row h-100 w-100">
    <div class="col-3">
        <ul class="nav nav-tabs h-100 flex-column nav-tabs-product-custom" id="simple-product-tab" role="tablist">
            {{-- Tab Giá sản phẩm --}}
            <li class="nav-item" role="presentation">
                <button class="nav-link w-100 active" id="price-tab" data-bs-toggle="tab" data-bs-target="#price-pane"
                    type="button" role="tab" aria-controls="price-pane" aria-selected="true">Giá sản phẩm</button>
            </li>
    ...
    <div class="col-9">
        <div class="tab-content tab-content-product" id="simple-productContent">
            ...
            <div class="tab-pane fade show active" id="price-pane" role="tabpanel" aria-labelledby="price-tab"
                tabindex="0">
